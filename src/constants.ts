export const ENDPOINTS = {
  incidents: "https://web.pulsepoint.org/DB/giba.php?agency_id=",
  coordsLookup: "https://web.pulsepoint.org/DB/gabc.php",
  agencyData: "https://web.pulsepoint.org/DB/GeolocationAgency.php?id=",
}

export const HASH_PASSWORD = "tombrady5rings"
